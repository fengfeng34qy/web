define(['public/demo/backbone/js/jquery', 'underscore', 'public/demo/backbone/js/backbone', 'require'],
	function ($, _, Backbone, require) {
		...
		var Router = Backbone.Router.extend({
			...
			changePage: function (view, action, actionArgs, opts) {
				...
				//			if (thisRouter.views[pageId+actionArgs] == undefined) thisRouter.views[pageId] = view;
				//			console.debug("changepage arguments:" + JSON.stringify(actionArgs));
